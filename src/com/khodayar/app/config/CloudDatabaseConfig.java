package com.khodayar.app.config;
...
import com.khodayar.app.models.MyAddRepository;
import com.khodayar.app.util.EntityManagerFactoryProvider;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackageClasses = MyAddRepository.class)
@Profile("cloud")
